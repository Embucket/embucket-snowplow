...
{# Narrow-projection QUALIFY moved to snowplow_web_pv_dedup_this_run for memory isolation #}
with prep as (
select
  ev.page_view_id,
  ev.event_id,
  ...
  inner join {{ ref('snowplow_web_pv_dedup_this_run') }} d on ev.event_id = d.event_id
